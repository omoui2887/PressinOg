 ...
 * <ClientDetailPage basePath="/personnel/receptionniste" /> qui gère toute
 ...
 *     /personnel/receptionniste/commandes/nouvelle?client_id={id}
 *   - les lignes d'historique de commandes pointent vers
 *     /personnel/receptionniste/commandes/{id}
 *   - le bouton "Retour" pointe vers /personnel/receptionniste/clients
 *
 ...
 *       manager OU receptionniste (actif + statut_compte='actif') — le
 *       réceptionniste peut donc éditer coordonnées, préférences et notes.
 */
