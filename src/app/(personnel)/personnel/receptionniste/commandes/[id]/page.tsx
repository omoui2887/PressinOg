 ...
 * <CommandeDetail basePath="/personnel/receptionniste" />.
 *
 * `basePath` est transmis pour que :
 *   - le bouton "Retour aux commandes" pointe vers
 *     /personnel/receptionniste/commandes
 *   - les liens internes (impression, étiquettes) restent cohérents
 *
 ...
 *
 *    ⚠️ Note sur les mutations : l'API PATCH /api/admin/commandes/[id] (statut
 *       d'article) et le POST /api/admin/commandes/[id]/articles acceptent
 *       n'importe quel personnel actif du pressing. Le réceptionniste peut
 *       donc mettre à jour le statut des articles s'il le souhaite (PRD).
 */
...
export default async function PersonnelReceptionnisteCommandeDetailPage({
  params,
}: PageProps) {
