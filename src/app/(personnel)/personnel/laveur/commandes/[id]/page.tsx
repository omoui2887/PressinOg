 ...
 *       pressing. Le laveur peut donc mettre à jour le statut des
 *       articles (recu → en_traitement → lave).
 */
...
export default async function LaveurCommandeDetailPage({
  params,
}: PageProps) {
