/**
 * e-pressing — Page « Compte suspendu » (AUDIT-B-04)
 * ---------------------------------------------------
 ...
 * super-admin e-pressing a suspendu l'abonnement, par exemple pour défaut de
 * paiement ou abus).
 *
 ...
 *   - propose un lien WhatsApp vers le support e-pressing pour régulariser
        ...
        <Card className="editorial-card glass-panel relative group ornate ornate-tl ornate-tr">
          ...
          <CardContent className="space-y-5">
            <p className="text-center text-sm leading-relaxed text-editorial-ivory-dim">
              L&apos;accès à votre espace e-pressing est temporairement
