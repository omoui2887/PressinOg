...
Vérifications Agent Browser (avec auth demo@ogpressing.test / [REDACTED-PWD]) :
...
- Reset password demo@ogpressing.test → "[REDACTED-PWD]" via service_role (pour test E2E).
